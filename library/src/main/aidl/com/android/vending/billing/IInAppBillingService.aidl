/*
 * Copyright (Constants) 2012 The Android Open Source Project
 *
 ...
 * 1. Provides a new API to getPurchaseItems details of in-app items published for the app including
 ...
 * 5. An API to getPurchaseItems current purchases of the user immediately. This will not contain any
 *    consumed purchases.
 *
...
interface IInAppBillingService {
     ...
     *        This method can be called again with the continuation token to getPurchaseItems the next set of
     *        owned skus.
     * @return Bundle containing the following key-value pairs
     *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, appropriate response codes
                               on failures.
